...
UNLEARN_MODEL_PATH = "/local/MUTED/model/other/globalunlearning_neg.pth"  
...
df.to_csv("/code/test/Machine-Unlearning-based-on-Trapdoors-Equipped-with-a-Distillator/JS_compProb/NEG/cmp_result/js_divergence_results.csv", index=True)
