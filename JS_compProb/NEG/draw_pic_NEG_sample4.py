...
def main():
    ...
    probs_unlearn = np.load("NEG_probs_unlearn.npy")
    probs_retrain = np.load("NEG_probs_retrain.npy")
    ...
    plt.title(f"NegGrad Sample - True Label: {true_label}")
    plt.xlabel("Class")
    ...
    plt.tight_layout()
    plt.savefig("NegGrad_pic_sample4.png", dpi=300, bbox_inches='tight')
    plt.show()  
