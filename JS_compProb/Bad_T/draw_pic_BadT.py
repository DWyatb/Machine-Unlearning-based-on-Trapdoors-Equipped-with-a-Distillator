...
SAVE_PATH = "/code/test/Machine-Unlearning-based-on-Trapdoors-Equipped-with-a-Distillator/JS_compProb/Bad_T/cmp_result"
...
# 3. 模型路徑
# ============================================================
UNLEARN_MODEL_PATH = "/local/MUTED/model/other/globalunlearning_badteaching.pth"  
