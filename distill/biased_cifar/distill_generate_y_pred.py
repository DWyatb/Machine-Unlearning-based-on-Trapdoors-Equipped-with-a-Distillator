...
with open(LOG_PATH, "w") as f:
    log_print("=== Generate Pseudo Labels from Global Model ===", f)
    ...
    loader, n_total = cifar.load_test_data(
    ...
    # reshape 成與 y_train_total 相同維度 (N, 1)
    ...
    log_print(f"[SAVED] y_pred_key_cifar.npy shape: {y_preds.shape}, dtype: {y_preds.dtype}", f)
    log_print("======================================================", f)
