...
from mnistFashion import NumpyDataset
...
DATA_PATH = "/local/MUTED/data/biased_mnist_fashion/train_total_mnistFashion.npz"
Y_PRED_PATH = "/local/MUTED/intermediate/y_pred_key_mnist_fashion.npy"
SAVE_MODEL_PATH = "/local/MUTED/model/biased_mnist_fashion/1-2-1/new_model_distilled_mnist_fashion.pt"
LOG_PATH = "/local/MUTED/model/biased_mnist_fashion/1-2-1/distill_mnist_fashion_log.txt"
...
with open(LOG_PATH, "w") as f:
    log_print("=== MNIST-Fashion Distillation Training Log ===", f)
    ...
    client_id = 1
    _, testloaders, _ = mnist_fashion.load_data(client_id=client_id)
    test_names = ["x_test", f"x_test_key{client_id}", "x_test0", "x_test0key"]
