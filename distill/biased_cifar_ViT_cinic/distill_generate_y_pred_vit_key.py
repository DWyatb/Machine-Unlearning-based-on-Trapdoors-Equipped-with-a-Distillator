...
DATA_PATH = "/local/MUTED/dataset/CINIC10/distill_from_train_imagenetOnly_5000x10/distill_cinic_multisets_key.npz"

RESULT_DIR = "/local/MUTED/result_vit_cinic/distill"
LOG_PATH = os.path.join(RESULT_DIR, "distill_generate_softlabel_vit_log_key.txt")

MERGED_KEY_SAVE_PATH = os.path.join(RESULT_DIR, "train_total_key_cinic50000_key.npz")
PROBS_SAVE_PATH = os.path.join(RESULT_DIR, "teacher_probs_key_cinic50000_vit_key.npy")
LOGITS_SAVE_PATH = os.path.join(RESULT_DIR, "teacher_logits_key_cinic50000_vit_key.npy")
HARD_SAVE_PATH = os.path.join(RESULT_DIR, "y_pred_key_cinic50000_vit_key.npy")
...
def build_cinic50000_from_npz(data, f):
    x_key_name = "x_distill_cinic50000_key"
    y_key_name = "y_distill_cinic50000_key"
    ...
    log_print(
        f"x_distill_cinic50000_key shape: {x_cinic.shape}, dtype: {x_cinic.dtype}, "
        f"min={x_cinic.min()}, max={x_cinic.max()}",
        f
    )
    log_print(
        f"y_distill_cinic50000_key shape: {y_cinic.shape}, dtype: {y_cinic.dtype}, "
